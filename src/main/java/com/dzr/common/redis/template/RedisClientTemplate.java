package com.dzr.common.redis.template;



import com.dzr.common.redis.dataSource.RedisDataSource;
...
public class RedisClientTemplate {
    ...
    public Long lpush(String key, List<String> strings) {
        ...
        boolean broken = false;
        try {
            result = shardedJedis.lpush(key,strings.toArray(new String[strings.size()]));
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            broken = true;
        } finally {
